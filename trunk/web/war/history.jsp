...
<body>
	...
	<div id="boardContainer" align="center">
		<label class='scoreMessage' id="lbMessage"></label>
		
		<div id="sbListContainer">
			<h4 align="left">&nbsp;Game Sessions</h4>
			<hr />
			<ul id="sbList" class="list">
		...
		<div id="scoreWindow" class="logWindow">
			...
			<div id="iconTray" style='height: 60px; '>
			</div>
